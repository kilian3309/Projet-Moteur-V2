	...
	float fElapsedTime, void* pUserContext)
{
	...
	g_infoHUD->addAdditionalInfos((std::to_wstring(XMVectorGetIntX(LookAtCamera))+strToWstr(" ")+std::to_wstring(XMVectorGetIntY(LookAtCamera))+strToWstr(" ")+std::to_wstring(XMVectorGetIntY(LookAtCamera))).c_str());
	g_infoHUD->Render();
