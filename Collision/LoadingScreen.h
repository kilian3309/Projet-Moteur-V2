...
void IncrementLoading(LPCWSTR txt=LPCWSTR(L"Loading...")) {
	...
	DrawText(loadingDeviceContext, txt, wcslen(txt), &loadingTextRect, DT_SINGLELINE | DT_NOCLIP);
	//PAINTSTRUCT ps;
...
void CreateLoadingScreen(HINSTANCE hInst = (HINSTANCE)nullptr, int maxRange = 6) {
	...
	loadingTextRect.bottom = loadingTextRect.bottom + 250;
